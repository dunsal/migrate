...
import (
	dStub "github.com/dunsal/migrate/v4/database/stub"
	"github.com/dunsal/migrate/v4/source"
	sStub "github.com/dunsal/migrate/v4/source/stub"
)
...
func ExampleNewWithDatabaseInstance() {
	...
	// `import "github.com/dunsal/migrate/v4/database/postgres"`
...
func ExampleNewWithSourceInstance() {
	...
	// `import "github.com/dunsal/migrate/v4/source/stub"`
